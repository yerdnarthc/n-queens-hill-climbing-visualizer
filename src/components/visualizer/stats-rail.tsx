...
> = {
  solved: {
    ...
    variant: 'default',
    className:
      'bg-green-pill hover:bg-green-pill/90 text-white shadow-xs dark:bg-green-pill dark:text-white font-medium text-[0.6rem] px-2.5 py-0.5',
  },
  stagnated: {
  ...
  frozen: {
    ...
    variant: 'outline',
    className:
      'border-blue-ls-200/20 bg-sky-500/10 text-sky-600 dark:text-blue-ls-200 font-medium text-[0.6rem] px-2.5 py-0.5',
  },
};
...
export interface StatsRailProps {
  /**
   * - "rail": vertical flex of 5 equal-height cards. Use inside the
   *   chessboard card on lg+ viewports.
   * - "compact": horizontal row of 5 condensed chips. Use above the board
   *   on sm/md viewports. Caller is responsible for scroll wrapper.
   */
